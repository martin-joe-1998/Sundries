...
namespace Math
{
	...
	inline float Log(float value, float base = E)
	{
...
public:
	...
	{
		Vector3 retVal;
		retVal.x = mat[0][0] * vec.x + mat[0][1] * vec.y + mat[0][2] * vec.z + mat[0][3];
		retVal.y = mat[1][0] * vec.x + mat[1][1] * vec.y + mat[1][2] * vec.z + mat[1][3];
		retVal.z = mat[2][0] * vec.x + mat[2][1] * vec.y + mat[2][2] * vec.z + mat[2][3];
		return retVal;
	}
...
public:
	...
	static Quaternion FindQuatBetween(const Vector3& from, const Vector3& to)
	{
