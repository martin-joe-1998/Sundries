...
bool Renderer::LoadShaders()
{
	...
	mGGlobalShader->SetIntUniform("uGSpecular", 1);
	mGGlobalShader->SetIntUniform("uGNormal", 2);
	mGGlobalShader->SetIntUniform("uGWorldPos", 3);
	...
	mGPointLightShader->SetIntUniform("uGSpecular", 1);
	mGPointLightShader->SetIntUniform("uGNormal", 2);
	mGPointLightShader->SetIntUniform("uGWorldPos", 3);
